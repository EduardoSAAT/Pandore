...
public class Explorer extends javax.swing.JFrame {
    ...
    private void jFileChooser1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jFileChooser1ActionPerformed
        JFileChooser selectArchivo = (JFileChooser)evt.getSource();
        String comando = evt.getActionCommand();
        
        //Lo que pasa con el Boton Aceptar//
        if(comando.equals(JFileChooser.APPROVE_SELECTION)){
            File ArchivoSeleccionado = selectArchivo.getSelectedFile();
            
            //Saber cual es la Ruta del ArchivoSeleccionado//
            System.out.println(ArchivoSeleccionado.getAbsolutePath());
            
            dispose();
        }
        
        //Lo que pasa con el Boton Cancelar//
    ...
    /**
     * Cambiar el nombre a main para que vuelva a funcionar esta clase
     * 
