 ...
 * @author Ing Lalux
 */
public class MatrizInteger implements Serializable{
    public int matrizRaiz[][];
    public int Alto;
    public int Ancho;
     ...
     */
    public MatrizInteger(int alto, int ancho){
        Alto=alto;
        Ancho=ancho;
        matrizRaiz=new int[Alto][Ancho];
    }
     ...
     */
    public void Inicializar(int ValorEspecifico){
     ...
     */
    public void addFilaArriba(int ValorRelleno){
    //Variables Locales e Inicializacion//
    boolean condiciones=true;
	String motivo="Indeterminado";
    //Comprobar Condiciones Iniciales//
     ...
     * @param	ValorRelleno  Valor a Poner en los nuevos Espacios que se creen
     */
    public void addFilaAbajo(int ValorRelleno){
    //Variables Locales e Inicializacion//
    boolean condiciones=true;
	String motivo="Indeterminado";
    //Comprobar Condiciones Iniciales//
     ...
     * @param	ValorRelleno  Valor a Poner en los nuevos Espacios que se creen
     */
    public void addColumnaDerecha(int ValorRelleno){
    //Variables Locales e Inicializacion//
    boolean condiciones=true;
	String motivo="Indeterminado";
    //Comprobar Condiciones Iniciales//
     ...
     * @param	ValorRelleno  Valor a Poner en los nuevos Espacios que se creen
     */
    public void addColumnaIzquierda(int ValorRelleno){
    //Variables Locales e Inicializacion//
    boolean condiciones=true;
	String motivo="Indeterminado";
    //Comprobar Condiciones Iniciales//
     ...
     */
    public void setVaule(int vaule, int alto, int ancho){
    //Variables Locales e Inicializacion//
    boolean condiciones=true;
    String motivo="Indeterminado";
    //Comprobar Condiciones Iniciales//
     ...
     * @param	ValorRelleno  Valor a Poner en los nuevos Espacios que se creen
     */
    public void setVauleForce(int vaule, int alto, int ancho, int ValorRelleno){
    //Variables Locales e Inicializacion//
    boolean condiciones=true;
    String motivo="Indeterminado";
    //Comprobar Condiciones Iniciales//
     ...
     */
    public int getVaule (int alto, int ancho){
    //Variables Locales e Inicializacion//
        boolean condiciones=true;
	String motivo="Indeterminado";
        int salida=0;
